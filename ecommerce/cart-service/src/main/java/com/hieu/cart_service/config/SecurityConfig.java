...
import com.hieu.cart_service.infrastructure.security.JwtAuthenticationFilter;
...
/**
 * Stateless JWT security chain. Cart has NO public endpoints;
 * all /api/cart/** require a valid JWT. Actuator + Swagger are open.
 */
@Configuration
@EnableWebSecurity
