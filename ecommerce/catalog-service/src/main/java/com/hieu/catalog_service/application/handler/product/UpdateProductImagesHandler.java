...
@Transactional
public class UpdateProductImagesHandler implements CommandHandler<UpdateProductImagesCommand, ProductDTO> {
    ...
    @Override
    public ProductDTO handle(UpdateProductImagesCommand cmd) {
        ...
        product.updateImages(cmd.thumbnail(), cmd.images(), cmd.updatedBy());
