...
@Transactional
public class UpdateVariantStockHandler implements CommandHandler<UpdateVariantStockCommand, VariantDTO> {
    ...
    @Override
    public VariantDTO handle(UpdateVariantStockCommand cmd) {
        ...
        product.updateVariantStock(variantId, Quantity.of(cmd.quantity()), cmd.updatedBy());
