...
public class ApproveReturnHandler implements CommandHandler<ApproveReturnCommand, ReturnRequestDTO> {
    ...
    @Override
    @Transactional
    public ReturnRequestDTO handle(ApproveReturnCommand cmd) {
