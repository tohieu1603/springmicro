...
/** Stateless JWT authentication filter — mirrors catalog-service implementation. */
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static List<String> extractList(Claims claims, String key) {
        ...
        return raw instanceof List<?> list ? list.stream().map(Object::toString).toList() : List.of();
    }
